    ...
    class Console {
        ...
        handleBackspace() {
            if (this.buffer.length > 0) {
                ...
                _DrawingContext.clearRect(this.currentXPosition - lastCharWidth, this.currentYPosition - this.currentFontSize, lastCharWidth, this.currentFontSize + _FontHeightMargin);
